...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 31, 2024 at 02:15 AM
...
(1, '<img class=\'icons\' src=\'./images/code-icon.svg\' alt=\'Code icon\' loading=\'lazy\'>', 'Front-end Development', 'Front-end development focuses on the visual aspects of a website – the part that users see and interact with.', 'Front-end developers work in languages like HTML, CSS, JavaScript, and various frameworks and libraries such as Bootstrap, AngularJS, React.js, Vue.js, jQuery, and Sass.', 'frontendcertifikates.html', 1),
...
(11, '<img class=\'icons\' src=\'./images/docker-icon.svg\' alt=\'Docker icon\' loading=\'lazy\'>', 'Container Platforms', 'Docker is a platform designed to help developers build, manage, share, run, and distribute modern applications.', 'Docker emerged as a de facto standard platform to quickly compose, create, deploy, scale, and oversee containers across Docker hosts, and runs on Linux, macOS and Windows.', 'dockercertificates.html', 1),
