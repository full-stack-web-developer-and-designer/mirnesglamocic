...
class FrontendIntroSlide extends Slider{
	...
	public function renderSlider(){
        $sql = "SELECT * FROM mirnesgl_korea.certifications WHERE skill='FrontendIntro' OR skill='FrontendIntro WebDesign'  OR skill='FrontendIntro UX WebDesign' ORDER BY rand();";
