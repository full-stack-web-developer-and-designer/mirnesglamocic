...
class Website extends ConnectSlider
{
    ...
    {
        $sql =
            "SELECT * FROM mirnesgl_korea.projects_website WHERE category='featured' OR category='fullstack'  OR category='mini' OR category='wordpress' ORDER BY projects_website_id DESC;";
