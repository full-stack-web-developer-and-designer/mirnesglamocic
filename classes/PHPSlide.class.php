...
class PHPSlide extends Slider{
	...
	public function renderSlider(){
        $sql = "SELECT * FROM mirnesgl_korea.certifications WHERE skill='PHP' AND class='LinkedIn preview' OR skill='PHP MySQL' OR skill='PHP WebDesigners' OR skill='Linux PHP' OR skill='WordPress PHP' OR skill='PHP SEO' ORDER BY rand();";
