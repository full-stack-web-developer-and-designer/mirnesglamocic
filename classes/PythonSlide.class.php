<?php
class PythonSlide extends Slider{
    // Fetch data from MySQL using PDO - PHP Data Object	
	public function renderSlider(){
        $sql = "SELECT * FROM mirnesgl_korea.certifications WHERE skill='Python' ORDER BY rand();";
        ...
        while($row = $stmt->fetch()) {
            ...
            <article class='cert' aria-label='Python certificates of professional web developer and web designer Mirnes Glamočić from Bosnia and Herzegovina'>
