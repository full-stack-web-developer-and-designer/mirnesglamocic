...
class ReactSlide extends Slider{
	...
	public function renderSlider(){
        $sql = "SELECT * FROM mirnesgl_korea.certifications WHERE skill='React' OR skill='React WebDesigners' ORDER BY rand();";
        ...
        while($row = $stmt->fetch()) {
            ...
            <article class='cert' aria-label='React certificates of professional web developer and web designer Mirnes Glamočić from Bosnia and Herzegovina'>
