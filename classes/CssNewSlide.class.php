...
class CssNewSlide extends Slider{
	...
	public function renderSlider(){
        $sql = "SELECT * FROM mirnesgl_korea.certifications WHERE skill='CSS' AND class='LinkedInNew preview' OR skill='CSS WebDesign' AND class='LinkedInNew preview' ORDER BY rand();";
