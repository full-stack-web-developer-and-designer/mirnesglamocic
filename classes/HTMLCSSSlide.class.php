<?php
class HTMLCSSSlide extends Slider{
    // Fetch data from MySQL using PDO - PHP Data Object	
	public function renderSlider(){
        $sql = "SELECT * FROM mirnesglamocic_cert.certifications WHERE skill='HTMLandCSS' OR skill='HTMLandCSS WebDesign' ORDER BY rand();";
