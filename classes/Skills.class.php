...
class Skills extends ConnectSlider{
	...
	public function renderSlider(){
        ...
        while($row = $stmt->fetch()) {
            ...
            <source srcset=\"./images/$img_100\" type=\"image/webp\" width=\"100\" height=\"100\" loading=\"lazy\" media=\"(min-width: 1153px)\">
            <source srcset=\"./images/$img_120\" type=\"image/webp\" width=\"120\" height=\"120\" loading=\"lazy\" media=\"(min-width: 1020px)\">
            <source srcset=\"./images/$img_110\" type=\"image/webp\" width=\"110\" height=\"110\" loading=\"lazy\" media=\"(min-width: 859px)\">
            <source srcset=\"./images/$img_105\" type=\"image/webp\" width=\"105\" height=\"105\" loading=\"lazy\" media=\"(min-width: 821px)\">
            <source srcset=\"./images/$img_100\" type=\"image/webp\" width=\"100\" height=\"100\" loading=\"lazy\" media=\"(min-width: 680px)\">
