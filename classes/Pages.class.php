...
class Pages extends Entity{
	...
	public function render(){
        ...
        <div class='wrapper'><img src='images/$this->my_image' alt='$this->alt' class='imgLeft'><h2>" . $this->title . "</h2><p>" . $this->pages_description . "</p></div></article><article id='about' class='white'><div class='wrapper'>
            <div id='quotes'>
