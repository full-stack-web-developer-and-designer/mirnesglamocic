...
class WebDesignPathSlide extends Slider{
	...
	public function renderSlider(){
        $sql = "SELECT * FROM mirnesgl_korea.certifications WHERE skill='WebDesignPath' OR skill='UX Intro WebDesign' OR skill='Frontend WebDesign' OR skill='FrontendIntro WebDesign' OR skill='FrontendIntro UX WebDesign' ORDER BY rand();";
