<?php
class SassSlide extends Slider{
    // Fetch data from MySQL using PDO - PHP Data Object	
	public function renderSlider(){
        $sql = "SELECT * FROM mirnesgl_korea.certifications WHERE skill='SASS' OR skill='SASS WebDesign' ORDER BY rand();";
        ...
        while($row = $stmt->fetch()) {
            ...
            <article class='cert' aria-label='SASS certificates of professional web developer and web designer Mirnes Glamočić from Bosnia and Herzegovina'>
