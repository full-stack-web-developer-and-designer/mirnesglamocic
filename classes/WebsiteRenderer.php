...
class WebsiteRenderer
{
    ...
    <img src=\"" . IMG_WEBSITES . "{$project->img}\" alt=\"" . htmlspecialchars($project->title) . "\" loading=\"lazy\">
</picture>";
            ...
            if (!empty($project->github)) {
                echo "
                <a href='https://github.com/full-stack-web-developer-and-designer/{$project->github}' target='_blank' class='btn secondary'>
