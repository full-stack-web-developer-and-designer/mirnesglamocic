...
<body id="home">
    <?php include 'inc/header.php';?>
        ...
        <article id='aboutme'>
            <div class='wrapper'>
                ...
                <!--[if IE 9]><video style='display: none;'><![endif]-->
                    ...
                    <!--[if IE 9]></video><![endif]-->
                    <img decoding="async" srcset="./images/webdev.jpg" width="310" height="310" loading="lazy" alt='Expert Web Developer and Designer from Bosnia and Herzegovina'>
                </picture>
        ...
        <section id="LinkedIn" aria-label="Certificates of LinkedIn and Pluralsight by professional web developer and web designer Mirnes Glamočić from Bosnia and Herzegovina">
            <div class="wrapper">
                <?php
