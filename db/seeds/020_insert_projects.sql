...
(1, 'WordPress Website for a Drone Services Company', 'Production-ready WordPress website built with a lightweight theme and optimized for performance, security, and clean layout structure.', 14);
