...
<?php 
	...
	$meta['description']="See the Frontend certificates of professional web designer and developer Mirnes Glamočić from Bosnia and Herzegovina. The best of the best!";
	$title=$fb_title;
