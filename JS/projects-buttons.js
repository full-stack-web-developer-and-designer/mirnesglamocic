/* Project target buttons functionality */
// Handles main tabs and nested tabs in your project section
...
nestedTabs.forEach((nestedTab) => {
    nestedTab.addEventListener("click", () => {
        ...
        const siblingTabs = nestedTab.closest(".nested-menu")?.querySelectorAll(".project.nested");
